...
ggsave("output/02_metodo2_tendencia.png", g_desc, width = 9, height = 5.5, dpi = 300, bg = "white")
ggsave("output/02_metodo2_residuo.png", g_resid, width = 9, height = 5.5, dpi = 300, bg = "white")

write_csv(datos, "output/02_metodo2_descomposicion.csv")
