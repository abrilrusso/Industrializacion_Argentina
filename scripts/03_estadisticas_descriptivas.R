...
write_csv(tabla_pib, "output/01c_tabla_pib_industrial.csv")
write_csv(tasas_subperiodo, "output/01c_tasas_subperiodo_argentina.csv")
write_csv(tabla_share, "output/01c_tabla_share_industrial.csv")
write_csv(tabla_primario, "output/01c_tabla_sector_primario.csv")
write_csv(tabla_exportaciones, "output/01c_tabla_exportaciones.csv")
